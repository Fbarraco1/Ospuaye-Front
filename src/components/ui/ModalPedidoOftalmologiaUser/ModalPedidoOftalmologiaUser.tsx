...
import styles from './ModalPedidoOftalmologiaUser.module.css';
import axios from 'axios';
import { useAuthStore } from '../../../auth/store/authStore';
import { useNavigate } from 'react-router-dom';
import Swal from 'sweetalert2';

const ModalPedidoOftalmologiaUser: React.FC<{ onPedidoAdded?: () => void }> = ({ onPedidoAdded }) => {
...
export default ModalPedidoOftalmologiaUser;
