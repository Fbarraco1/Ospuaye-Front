...
import { ModalEstadoOftalmologia } from '../../ui/ModalEstado/ModalEstadoOftalmologia';
...
export const PedidoOftalmologiaMedico: React.FC = () => {
  ...
  const obtenerPedidos = async (id: number) => {
    try {
      const response = await axios.get(`http://vps-5301866-x.dattaweb.com:9000/api/pedidos/oftalmologia/medico/${id}`);
